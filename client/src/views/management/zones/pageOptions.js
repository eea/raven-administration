const pageOptions = (lookups) => ({
  ...
  properties: [
    ...
    { type: "text", label: "National Code", prop: "zone_national_code", placeholder: "str: A unique code", required: true, default: null, enableInEdit: true, showInGrid: true },
    { type: "text", label: "Name", prop: "name", placeholder: "str: Name of zone", required: true, default: null, enableInEdit: true, showInGrid: true },
    { type: "number", label: "Area (km²)", prop: "zone_area", placeholder: "float: Area in km2", required: true, default: null, enableInEdit: true, showInGrid: true },
