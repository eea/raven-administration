const pageOptions = (lookups) => ({
  ...
  properties: [
    ...
    { type: "lookup", label: "Station", prop_id: "station_id", prop: "station", lookup: "stations", required: true, default: null, showInEdit: true, showInGrid: true },
    ...
    { type: "lookup", label: "Timestep", prop_id: "timestep_id", prop: "timestep", required: true, lookup: "timesteps", default: null, showInEdit: true, showInGrid: true },
    { type: "lookup", label: "Concentration", prop_id: "concentration_id", prop: "concentration", required: true, lookup: "concentrations", default: null, showInEdit: true, showInGrid: true },
    { type: "lookup", label: "Station classification", prop_id: "station_classification_id", prop: "station_classification", required: true, lookup: "stationclassifications", default: null, showInEdit: true, showInGrid: true },
    ...
    // OPTIONAL
    { type: "text", label: "Logger id", prop: "logger_id", placeholder: "str: Logger id for push functionality", required: false, default: null, showInEdit: true, showInGrid: false },
    { type: "text", label: "Main emission sources", prop: "main_emission_sources", placeholder: "str: Main Emission Sources", required: false, default: null, showInEdit: true, showInGrid: false },
    { type: "text", label: "Change aei stations", prop: "change_aei_stations", placeholder: "str: Change aei stations", required: false, default: null, showInEdit: true, showInGrid: false },
    { type: "text", label: "Distance source", prop: "distance_source", placeholder: "str:  Distance source", required: false, default: null, showInEdit: true, showInGrid: false },
    { type: "text", label: "Industrial emissions", prop: "industrial_emissions", placeholder: "str:  Industrial emissions", required: false, default: null, showInEdit: true, showInGrid: false },
