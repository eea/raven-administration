const pageOptions = (lookups) => ({
  ...
  properties: [
    ...
    { type: "lookup", label: "Network", prop_id: "network_id", prop: "network", lookup: "networks", required: true, default: null, enableInEdit: true, showInGrid: true },
    { type: "lookup", label: "Area classification", prop_id: "area_classification_id", prop: "area_classification", required: true, lookup: "areaclassifications", default: null, enableInEdit: true, showInGrid: true },
    ...
    { type: "text", label: "Eoi", prop: "eoi_code", placeholder: "str: Eoi Code", required: true, default: null, enableInEdit: true, showInGrid: false },
    ...
    { type: "number", label: "Heavy Duty Fraction", prop: "heavy_duty_fraction", placeholder: "float: Heavy Duty Fraction", required: false, default: null, enableInEdit: true, showInGrid: false },
    { type: "number", label: "Height Facade", prop: "height_facade", placeholder: "float: Height Facade", required: false, default: null, enableInEdit: true, showInGrid: false },
