...
def groups():
    with CursorFromPool() as cursor:
        sql = """
			      select
                  g.id, g.name, g.management, g.data, g.exporting, g.processing, g.qualitycontrol, g.allnetworks, g.users, g.plugin_permissions,
            ...
            group by g.id, g.name, g.management, g.data, g.exporting, g.processing, g.qualitycontrol, g.allnetworks, g.users, g.plugin_permissions
...
def groups_insert():
    ...
    add_group(model.name, model.management, model.data, model.exporting, model.processing, model.qualitycontrol, model.users, model.allnetworks, model.networks, model.plugin_permissions)
    return jsonify({"success": True})
...
def groups_update():
    ...
    update_group(model.id, model.name, model.management, model.data, model.exporting, model.processing, model.qualitycontrol, model.users, model.allnetworks, model.networks, model.plugin_permissions)
    return jsonify({"success": True})
